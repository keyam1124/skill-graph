...
class SkillGraphViewerWorkflowTest(unittest.TestCase):
    ...
    def test_enriched_graph_annotations_and_viewer_html(self):
        ...
        self.assertIn("全体を把握する", html)
        self.assertIn("つながりを確認する", html)
        self.assertIn("気になる点を確認する", html)
        self.assertIn("スキルを探す", html)
        ...
        self.assertIn("全体について", html)
        self.assertIn("選択中のスキル", html)
        self.assertIn("つながりの詳細", html)
        self.assertIn("気になる点の詳細", html)
        self.assertIn("state.activePage", html)
        self.assertIn("showDirectRelations", html)
        self.assertIn("showAiRelations", html)
        self.assertIn("showGroupFrames", html)
